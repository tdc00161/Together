                            ...
                            @foreach ($data as $key => $item)
                                <div class="gantt-task" id="gantt-task-{{$item->id}}">
                                    ...
                                    <div class="responName gantt-dropdown">
                                        <span>{{$item->name}}</span>
                                    <div>
                                        <div class="statusName gantt-status-color gantt-dropdow" onclick="statusSelectDropdown()" data-status="{{$item->task_status_name}}">
                                            <span>{{$item->task_status_name}}</span>
                                            <select name="statusDropdown" class="statusDropdown" style="display: none;">
